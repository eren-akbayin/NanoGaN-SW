...
void TIM4_IRQHandler(void)
{
  /* USER CODE BEGIN TIM4_IRQn 0 */
	uDTC[0][index_sine] = (uint32_t)(arm_sin_f32(angle) * fDuty * 3437.0f + 3437.0f);
	uDTC[1][index_sine] = (uint32_t)(arm_sin_f32(angle + 2.0f * PI / 3.0f) * fDuty * 3437.0f + 3437.0f);
	uDTC[2][index_sine] = (uint32_t)(arm_sin_f32(angle - 2.0f * PI / 3.0f) * fDuty * 3437.0f + 3437.0f);

	TIM1->CCR3 = uDTC[0][index_sine];

	TIM1->CCR2 = uDTC[1][index_sine];

	TIM1->CCR1 = uDTC[2][index_sine];
